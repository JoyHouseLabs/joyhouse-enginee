...
export class TaskGroupController {
  ...
  @ApiResponse({ status: 201, description: 'The task group has been successfully created.', type: TaskGroupDto })
  ...
  @ApiResponse({ status: 200, description: 'The task group has been successfully updated.', type: TaskGroupDto })
  async update(@Param('id') id: string, @Body() updateDto: UpdateTaskGroupDto): Promise<TaskGroupDto> {
    updateDto.id = id;
  ...
  @ApiResponse({ status: 200, description: 'Return the task group.', type: TaskGroupDto })
  ...
  @ApiResponse({ status: 200, description: 'Return all task groups.', type: [TaskGroupDto] })
  ...
  @ApiResponse({ status: 200, description: 'The task item has been successfully added to the task group.', type: TaskGroupDto })
  async addTaskItem(
  ...
  @ApiResponse({ status: 200, description: 'The task item has been successfully removed from the task group.', type: TaskGroupDto })
