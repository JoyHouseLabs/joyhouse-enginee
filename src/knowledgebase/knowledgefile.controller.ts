...
import { KnowledgefileDto } from '../dto/knowledgefile.dto';
import { KnowledgefileCreateDto } from '../dto/knowledgefile-create.dto';
import { KnowledgefileUpdateDto } from '../dto/knowledgefile-update.dto';
...
export class KnowledgefileController {
  ...
  async getAll(@Req() req, @Query() query: import('../dto/knowledgefile-query.dto').KnowledgefileQueryDto) {
  ...
  async create(@Body() body: import('../dto/knowledgefile-create.dto').KnowledgefileCreateDto, @Req() req) {
    const userId = req.user.sub;
  ...
  async update(@Body() body: import('../dto/knowledgefile-update.dto').KnowledgefileUpdateDto, @Req() req) {
    const userId = req.user.sub;
